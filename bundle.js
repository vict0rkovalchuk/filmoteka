...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[2].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/scss/styles.scss
var styles = __webpack_require__(931);
...
/* harmony default export */ const scss_styles = ((styles_default()).locals || {});
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./src/css/bootstrap-reboot.min.css
var bootstrap_reboot_min = __webpack_require__(579);
var bootstrap_reboot_min_default = /*#__PURE__*/__webpack_require__.n(bootstrap_reboot_min);
;// CONCATENATED MODULE: ./src/css/bootstrap-reboot.min.css

            

var bootstrap_reboot_min_options = {};

bootstrap_reboot_min_options.insert = "head";
bootstrap_reboot_min_options.singleton = false;

var bootstrap_reboot_min_update = injectStylesIntoStyleTag_default()((bootstrap_reboot_min_default()), bootstrap_reboot_min_options);



/* harmony default export */ const css_bootstrap_reboot_min = ((bootstrap_reboot_min_default()).locals || {});
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/bootstrap/dist/css/bootstrap.min.css
var bootstrap_min = __webpack_require__(338);
...
var bootstrap_min_update = injectStylesIntoStyleTag_default()((bootstrap_min_default()), bootstrap_min_options);



/* harmony default export */ const css_bootstrap_min = ((bootstrap_min_default()).locals || {});
// EXTERNAL MODULE: ./node_modules/slick-carousel/slick/slick.js
var slick = __webpack_require__(154);
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/slick-carousel/slick/slick.css
var slick_slick = __webpack_require__(386);
var slick_slick_default = /*#__PURE__*/__webpack_require__.n(slick_slick);
;// CONCATENATED MODULE: ./node_modules/slick-carousel/slick/slick.css

            

var slick_options = {};

slick_options.insert = "head";
slick_options.singleton = false;

var slick_update = injectStylesIntoStyleTag_default()((slick_slick_default()), slick_options);
...
var FilmsByYear = /*#__PURE__*/function () {
  ...
  _createClass(FilmsByYear, [{
    ...
    value: function fetchFilms(url, releaseData, counter) {
      ...
      fetch("".concat(url + releaseData, "&page=").concat(counter)).then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log(data);
        ...
        jquery_default()('.pagination-year').css('display', 'block');
    ...
    value: function addListeners() {
      ...
      this.input.addEventListener('input', this.inputChange.bind(this)); // window.addEventListener('load', this.fetchFilms.bind(this));
    }
  }, {
    key: "init",
    value: function init() {
...
;// CONCATENATED MODULE: ./src/js/genreList.js
function genreList_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function genreList_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function genreList_createClass(Constructor, protoProps, staticProps) { if (protoProps) genreList_defineProperties(Constructor.prototype, protoProps); if (staticProps) genreList_defineProperties(Constructor, staticProps); return Constructor; }
...
var GenreList = /*#__PURE__*/function () {
  ...
  genreList_createClass(GenreList, [{
    key: "fetchDefaultFilms",
    value: function fetchDefaultFilms() {
      this.fetchFilms();
    }
...
var GetLocalStorage = /*#__PURE__*/function () {
  ...
  getLocalStorage_createClass(GetLocalStorage, [{
    ...
    value: function fetchCollection() {
      ...
      switch (this.idsCollection === null) {
        ...
        case false:
          ...
          this.ul.innerHTML = '';
          this.idsCollection.forEach(function (id) {
            fetch("https://api.themoviedb.org/3/movie/".concat(id, "?api_key=fb2d223cbf586b1c9599530eaa26a8db")).then(function (res) {
              return res.json();
            }).then(function (film) {
              _this.renderItem(film);
            })["catch"](function (err) {
              return alert(err);
            });
          });
    ...
    key: "renderItem",
    value: function renderItem(film) {
      this.ul.innerHTML += "<li class=\"item\">\n    <div class=\"item__img\">\n      <img\n        src=\"https://image.tmdb.org/t/p/w500/".concat(film.poster_path, "\"\n        alt=\"img\"\n      />\n      <div class=\"hover-effect\">\n        <div class=\"hover-text\">\n      <button type=\"button\" data-id=\"").concat(film.id, "\" class=\"btn btn-watched btn-outline-light\">add to Watched</button>\n      <button type=\"button\" data-id=\"").concat(film.id, "\" class=\"btn btn-queue btn-outline-light\">add to Queue</button>\n      <button type=\"button\" data-id=\"").concat(film.id, "\" class=\"btn btn-watch btn-outline-light\">watch</button>\n        </div>\n      </div>\n    </div>\n\n<div class=\"item__descr\">\n  <div class=\"item__title\" data-id=\"").concat(film.id, "\">").concat(film.original_title, "</div>\n  <div class=\"item__info\">\n    <a href=\"#main\" class=\"item__releasedata\" data-release='").concat(new Date(film.release_date).getFullYear(), "'><span>").concat(new Date(film.release_date).getFullYear(), "</span>,&ensp;</a>\n    <div class=\"item__country\">\n  Rating: ").concat(film.vote_average, "/10\n    </div>\n  </div>\n</div>\n</li>");
    }
  }, {
    key: "init",
    value: function init() {
